...
type fileWriterSource interface{ Stream() (io.ReadCloser, error) }
type TextWriterSource struct{ Text string }
...
type resourceWriterReadCloser struct{ buffer *bytes.Buffer }
...
type MultiSourceFileWriter struct{ printer printers.ResourcePrinter }
